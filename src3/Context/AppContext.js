...
const BASE_socketUrl = {
  ...
  development: 'http://192.168.1.61:3000',
  // production: "http://145.223.18.56:3001/",    
};
...
export const AppProvider = ({ children }) => {
  ...
  const Urls = useMemo(() => {
    ...
    return {
      ...
      maskedCall: `${serviceManUrl}customer-detail`,
      getDistence: `${serviceManUrl}nearby`,

      targetEndpoint: `${serviceManUrl}target`,
      WinnersHistoryEndpoint: `${serviceManUrl}weekly-winner`,

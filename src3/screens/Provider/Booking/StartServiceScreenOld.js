...
const StartServiceScreen = ({ navigation, route }) => {
  ...
  const retryLocationCheck = async () => {
    ...
    if (isAtLocation) {
      // Auto move to next step if location verified
      setCurrentStep(2);
    }
  };
    ...
    <View style={clsx(styles.p4)}>
      <View style={clsx(styles.itemsCenter, styles.mb8)}>
        <View style={[
          ...
          <Icon name="camera-alt" size={50} color={colors.primary} />
        </View>
      ...
      <View style={clsx(styles.flexRow, styles.gap4, styles.mb8)}>
        ...
        {selectedSelfie ? (
          ...
          <TouchableOpacity
            ...
            onPress={takeSelfie}
            disabled={takingSelfie || !cameraPermission}
          >
            {takingSelfie ? (
              <ActivityIndicator size="small" color={colors.white} />
            ) : (
      ...
      {!cameraPermission && (
        <Text style={clsx(styles.textSm, styles.textError, styles.textCenter, styles.mt4)}>
          Camera permission is required to take selfie. Please enable camera permissions in settings.
        </Text>
      )}
    </View>
  );
  ...
  const renderOTPStep = () => (
    <View style={clsx(styles.p4)}>
      ...
      <View style={clsx(styles.mb8)}>
        ...
        {/* OTP Actions */}
        <View style={clsx(styles.flexRow, styles.justifyCenter, styles.mb4)}>
          {!otpSent ? (
            <TouchableOpacity
              style={clsx(
                styles.flexRow,
            ...
            <View style={clsx(styles.itemsCenter)}>
              ...
              >
                <Text style={clsx(
                  styles.textPrimary,
                  styles.fontMedium,
                  (otpTimer > 0 || loading) && styles.opacity50
                )}>
                  {otpTimer > 0 
      ...
      <View style={clsx(styles.mb8)}>
        <TouchableOpacity
          style={clsx(
            ...
            styles.roundedLg,
            styles.bgSuccess,
            (verifyingOTP || otpInputs.some(digit => !digit)) && styles.opacity50
          )}
          onPress={verifyOTP}
      ...
      <View style={clsx(styles.flexRow, styles.gap4)}>
        ...
        <TouchableOpacity
          ...
          disabled={verifyingOTP}
        >
          <Icon name="cancel" size={24} color={colors.primary} style={clsx(styles.mr2)} />
          <Text style={clsx(styles.textPrimary, styles.fontBold, styles.textLg)}>
            Cancel
          </Text>
        </TouchableOpacity>
          ...
          <React.Fragment key={step}>
            <View style={clsx(styles.flexRow, styles.itemsCenter)}>
              <View style={[
                ...
                { 
                  ...
                  backgroundColor: currentStep === step ? colors.primary : 
                                 currentStep > step ? colors.success : colors.gray300
                }
              ]}>
                {currentStep > step ? (
                  ...
                  <Text style={[
                    ...
                    { color: currentStep === step ? colors.white : colors.gray600 }
                  ]}>
                    {step}
                  </Text>
                )}
              ...
              <Text style={[
                ...
                { 
                  color: currentStep === step ? colors.primary : 
                         currentStep > step ? colors.success : colors.gray500
                }
              ]}>
                {step === 1 ? 'Location' : 
                 step === 2 ? 'Selfie' : 'OTP'}
